...
export declare abstract class Common {
    ...
    abstract WebrtcOnPublishStateUpdateHandle(
        type: 0 | 1 | 2,
        streamid: string,
        error: {
            code: string;
    ...
    abstract onRecvInviteJoinLiveRequest(
        requestId: string,
        from_userid: string,
        from_username: string,
        roomid: string,
    ): any;
    abstract onRecvEndJoinLiveCommand(
        requestId: string,
        from_userid: string,
        from_username: string,
        roomid: string,
