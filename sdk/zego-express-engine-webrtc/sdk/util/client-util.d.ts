...
export declare class ClientUtil {
    ...
    static mergeUserList(
        logger: Logger,
        oldUserList: any[],
        newUserList: any[],
        callbackResult: (addUserList: any[], delUserList: any[]) => void,
    ): void;
    ...
    static isSupportLive(
        sucCall: {
            (arg0: { code: number; msg: string }): void;
            (arg0: { code: number; msg: string }): void;
        },
        errCall: (arg0: any) => void,
    ): void;
